...
TextRenderer::TextRenderer()
{
	...
	this->shader = new Shader("textVertexShader.vs", "textFragmentShader.fs");

	int width, height, nrChannels;

	unsigned char* data = stbi_load("font.png", &width, &height, &nrChannels, 0);
...
void TextRenderer::DrawText(const std::string &str, unsigned int xPos, unsigned int yPos)
{
	...
	this->shader->setMat4(glm::mat4(0.8f), "model");
	this->shader->setMat4(glm::mat4(1.0f), "view");
